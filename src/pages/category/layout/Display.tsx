            ...
            <div id="view" className='w-full h-full flex flex-col items-center justify-start'>
                ...
                >
                    ...
                    {childTagsColor.map((color, index) => (
                        <div className={`children border-2 border-${color}-400 w-[calc(400px/5)] h-[calc(400px/5)] bg-${color}-400 bg-opacity-20 text-center text-xs font-bold`}
                            key={index}
                            style={
                                activeTags[index] === 1 ? {'display': display} : {}
                            }
                        >
                            Children {index + 1}
                        </div>
