...
const ColumnGap: React.FC = () => {
    ...
    const dependencies = [columnGap, useBoxOption, boxCount, boxSize];
    useOverflowHandler(['#column-gap'], () => 0, setBoxTranslateY, dependencies);
    ...
    return (
        <>
            <div id='option-wrap' className='absolute top-10 left-6 transition-transform duration-500 z-[1000]'>
                <div className='w-72 flex flex-col gap-2 shadow rounded-xl p-2 bg-white border border-gray-200 hover:shadow-2xl hover:border-gray-300 transition-all duration-500'>
                    ...
                    <div className='flex flex-col gap-2'>
                        <div className='text-center pt-2 font-bold text-lg'>Column Gap</div>
                        <div className='px-4 text-xs text-right font-bold'><span className='text-red-700'>*</span> flex-direction: column</div>
                    </div>
                    ...
                    <div id='option-wrap-bottom' className='flex flex-col gap-2 max-h-[360px] overflow-y-scroll px-2'>
                        ...
                        <div className='text-center p-0.5 text-xs'>
                            ...
                            <button className='copy-css-btn btn btn-square btn-ghost btn-xs ml-2 flip-horizontal-bottom'
                                onClick={() => copyCss('column-gap', columnGap, units)}
                            >
            ...
            <div id="view" className='w-full h-full flex items-center justify-center overflow-scroll'>
                <div id='column-gap' className='flex w-[500px] h-[500px] bg-blue-50 shadow transition-[column-gap] transition-transform duration-300'
                    style={{
                        flexFlow: 'row wrap',
                        alignContent: 'start',
                        columnGap: `${columnGap}${units}`,
