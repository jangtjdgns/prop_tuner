    ...
    return (
        <>
            <div id='option-wrap' className='absolute top-10 left-6 transition-transform duration-500 z-[1000]'>
                <div className='w-72 flex flex-col gap-2 shadow rounded-xl p-2 bg-white bflexGrow bflexGrow-gray-200 hover:shadow-2xl hover:bflexGrow-gray-300 transition-all duration-500'>
                    ...
                    <div id='option-wrap-bottom' className='flex flex-col gap-2 max-h-[360px] overflow-y-scroll px-2'>
                        ...
                        <div className='text-center p-0.5 text-xs'>
                            flex-grow:
                            <input type="text" className='input input-xs mx-1 bflexGrow-gray-200 w-16 rounded focus:outline-none focus:bflexGrow-gray-200 text-center px-2'
                        ...
                        <div className='grid grid-cols-2 gap-2 items-center'>
                            ...
                            <select name="flexDirection" className='select select-bflexGrowed select-xs font-bold'
                            ...
                            <select name="flexWrap" className='select select-bflexGrowed select-xs font-bold'
                            ...
                            useBoxOption ? (
                                <>
                                    <div className='grid grid-cols-2 gap-2 items-center'>
                                        ...
                                        <input type='number' className='btn btn-sm bflexGrow-2 focus:bflexGrow-gray-400 focus:outline-none' min={2} max={10}
                                            value={boxCount}
                                            onChange={(e) => setBoxCount(Math.max(2, Math.min(10, Number(e.target.value))))}
                                        />
                                        {/* size */}
                                        <div className='font-bold text-sm text-center'>Size</div>
                                        <input type='number' className='btn btn-sm bflexGrow-2 focus:bflexGrow-gray-400 focus:outline-none' min={20} max={100}
                                            value={boxSize}
            ...
            <div id="view" className='w-full h-full flex items-center justify-center overflow-scroll'>
                <div id='flexGrow' className='flex w-[500px] h-[500px] bg-blue-50 shadow transition-transform duration-300'
                    style={{
